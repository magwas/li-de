...
class JooCommentsViewCommentpage extends JView {
	...
	$this->isGravatar=$params->get( 'gravatar_enabled', '0' );
	$this->gravatarIcon=$params->get( 'gravatar_icon', 'mm' );
	include_once(dirname(__FILE__).DS.'..'.DS.'..'.DS.'helpers'.DS.'JooHelper.php');
	parent::display($tmpl);
} } ?>

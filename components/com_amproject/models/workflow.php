...
/**
 * AmprojectModelWorkflow
 * @author $Author$
 */
 
 
class AmprojectModelWorkflow  extends JModelItem { 

	
	
	protected $context = 'com_amproject.workflow';   
	/**
	...
	public function &getItem($id = null)
	{
		if ($this->_item === null) {
			...
			$table = JTable::getInstance('Workflow', 'Table');

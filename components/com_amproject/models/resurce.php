...
/**
 * AmprojectModelResurce
 * @author $Author$
 */
 
 
class AmprojectModelResurce  extends JModelItem { 

	
	
	protected $context = 'com_amproject.resurce';   
	/**
	...
	public function &getItem($id = null)
	{
		if ($this->_item === null) {
			...
			$table = JTable::getInstance('Resurce', 'Table');

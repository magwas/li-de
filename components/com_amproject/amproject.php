<?php
/**
 * @version $Id: #component#.php 125 2012-10-09 11:09:48Z michel $ 1 2014-12-30Z FT $
* @package	Amproject
...
$config 	=& JComponentHelper::getParams( 'com_amproject' );

$controller = JRequest::getWord('view', 'condition');
...
$classname    = 'AmprojectController'.$controller;

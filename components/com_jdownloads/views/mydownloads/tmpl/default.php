 ...
 */
 ...
 setlocale(LC_ALL, 'C.UTF-8', 'C');
    ...
    if ($header != ''){
        ...
        $upload_link = '<a href="'.JRoute::_('index.php?option=com_jdownloads&amp;view=upload&amp;Itemid='.$menuItemids['upload']).'">'.'<img src="'.JURI::base().'components/com_jdownloads/assets/images/upload.png" width="32" height="32" border="0" alt="'.JText::_('COM_JDOWNLOADS_UPLOAD_LINKTEXT').'" /></a> <a href="'.JRoute::_('index.php?option=com_jdownloads&amp;view=upload&amp;Itemid='.$menuItemids['upload'].'').'">'.JText::_('COM_JDOWNLOADS_UPLOAD_LINKTEXT').'</a>';
    ...
    if ($layout_files_text != ''){
        ...
        for ($i = 0; $i < count($files); $i++) {
            ...
            if ($jlistConfig['view.detailsite']){
                ...
                //$titel_link = JRoute::_('index.php?option=com_jdownloads&amp;view=download&catid='.$files[$i]->cat_id.'&id='.$files[$i]->file_id.'&amp;Itemid='.$file_itemid);

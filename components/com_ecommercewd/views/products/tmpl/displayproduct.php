...
<div id="categoryLink">
	<a class="editProductLink btn btn-primary" 
	   href="index.php?option=com_ecommercewd&controller=categories&task=displaycategory&category_id=<?php echo $product_row->category_id; ?>&Itemid=<?php echo JRequest::getVar('Itemid'); ?>">
	   <?php echo '&lt;&lt; '.JText::_('COM_ECOMMERCEWD_CATEGORY'); ?>
	</a>   
</div>
...
if (($user->id > 0) & ($user->username == $this->product_row->model)) { ?>
	...
	<a class="productOrderLink btn btn-primary" 
	   href="index.php?option=com_ecommercewd&controller=orders&task=displayorders&product_id=<?php echo JRequest::getVar('product_id'); ?>&Itemid=<?php echo JRequest::getVar('Itemid'); ?>">
...
<div class="container <?php if ($product_row->published == 0) echo ' productUnPublished'; ?>" itemscope itemtype="http://schema.org/Product">
<!-- main data -->
<?php

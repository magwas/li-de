...
WDFHelper::add_css('css/' . WDFInput::get_controller() . '/' . $this->_layout . '_barfilters.css');
WDFHelper::add_script('js/' . WDFInput::get_controller() . '/' . $this->_layout . '_barfilters.js');
...
if ($options->search_enable_search == 1) {
    ...
    <div class="row">
        ...
        if ($options->filter_manufacturers == 1) {
            ...
            <div class="<?php echo $filters_col_class; ?>">
                <fieldset>
                    <h5 class="wd_shop_header_sm"><?php echo WDFText::get('MANUFACTURERS') ?></h5>
        ...
        if ($options->filter_price == 1) {
            ...
            <div class="<?php echo $filters_col_class; ?>">
                <fieldset>
                    <h5 class="wd_shop_header_sm"><?php echo WDFText::get('PRICE') ?></h5>

                    <div class="form-group">
                        <label for="wd_shop_bar_filters_filter_price_from" class="col-sm-5 control-label">
                            <?php echo WDFText::get('PRICE_FROM') . '&nbsp;(' . $row_default_currency->sign . ')'; ?>:
                        </label>
                        ...
                        <div class="col-sm-7">
                            <input type="text"
                                   ...
                                   onblur="wdShop_formFilters_onPriceChange(event, this);">
                        </div>
                    </div>

                    <div class="form-group">
                        <label for="wd_shop_bar_filters_filter_price_to" class="col-sm-5 control-label">
                            <?php echo WDFText::get('PRICE_TO') . '&nbsp;(' . $row_default_currency->sign . ')'; ?>:
                        </label>
                            ...
                            <div class="col-sm-12 text-right">
                                <a class="btn btn-default btn-xs"
                                   onclick="wdShop_formFilters_onBtnUpdatePricesClick(event, this); return false;">
                                    <?php echo WDFText::get('BTN_UPDATE_FILTERS'); ?>
                                </a>
                            </div>
                        </div>
                    <?php
        ...
        if ($options->filter_date_added == 1) {
            ...
            <div class="<?php echo $filters_col_class; ?>">
                <fieldset>
                    <h5 class="wd_shop_header_sm"><?php echo WDFText::get('DATE_ADDED') ?></h5>
        ...
        if (($options->feedback_enable_product_rating == 1) && ($options->filter_minimum_rating == 1)) {
            ...
            <div class="<?php echo $filters_col_class; ?>">
                <fieldset>
                    <h5 class="wd_shop_header_sm"><?php echo WDFText::get('MINIMUM_RATING') ?></h5>
                            ...
                            <li>
                                <div class="radio">
                                    <label>
                                        ...
                                        <?php
                                        echo WDFHTML::jf_bs_rater('', 'wd_shop_star_rater', '', $i, false, '', '', true, 5, 14, $theme->rating_star_type, $theme->rating_star_color, $theme->rating_star_bg_color);
                                        ?>
                                    </label>
                                </div>
                            </li>
    ...
    if ($options->filter_tags == 1) {
        ...
        <div class="row">
            <div class="col-sm-12">
                <fieldset>
                    <h5 class="wd_shop_header_sm"><?php echo WDFText::get('TAGS_SEPARATED_BY_COMMA') ?></h5>
            ...
            <div class="col-sm-12 text-right">
                <a class="btn btn-default btn-sm"
                   onclick="wdShop_formFilters_onBtnResetClick(event, this); return false;">
                    <?php echo WDFText::get('BTN_RESET'); ?>
                </a>
            </div>
        </div>
    <?php

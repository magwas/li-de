 ...
 * K2
 */
class Cleaners_com_k2 extends JObject
{
	public			$name		=	'K2';
	public			$version	=	'2.5.5';
	private static 	$extension 	= 	'com_k2';
	...
	{
		return array(
			'jquery' => '/media/k2/assets/js/jquery-.*?\.min\.js',
			'jqueryui' => '/media/k2/assets/js/jquery-ui-.*?\.min\.js',
		);
		return false;
	}

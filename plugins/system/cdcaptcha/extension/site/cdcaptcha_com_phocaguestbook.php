 ...
 * Phoca Guestbook
 */
class CdCaptcha_com_phocaguestbook
{
	public $name = 'Phoca Guestbook';
	...
	{
		static $instance;
		if ($instance == null) $instance = new CdCaptcha_com_phocaguestbook();
	...
	public function formObject()
	{
		...
		{
			case 'guestbook':
				$formObject->formElement = 'form#pgbSaveForm';

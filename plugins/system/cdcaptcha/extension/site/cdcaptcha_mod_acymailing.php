 ...
 * AcyMailing Module
 */
class CdCaptcha_mod_acymailing
{
	public $name = 'AcyMailing Module';
	...
	{
		static $instance;
		if ($instance == null) $instance = new CdCaptcha_mod_acymailing();
	...
	public function formObject()
	{
		...
		$formObject->formElement = 'form[name*="formAcymailing"]';
		
		$formObject->scriptDeclaration = "
				// Mootools slide
				if(container.closest('.acymailing_mootoolsbutton').length) {

 ...
 * AcyMailing Starter
 */
class CdCaptcha_com_acymailing
{
	public $name = 'AcyMailing Starter';
	...
	{
		static $instance;
		if ($instance == null) $instance = new CdCaptcha_com_acymailing();
	...
	public function formObject() {
		...
		{
			case 'user':
				$formObject->formElement = 'form[action*="' . JRoute::_('index.php', false) . '"]';
				break;

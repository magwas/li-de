...
*/
 defined('_JEXEC') or die('Restricted access');
/**
 * AmprojectModelEvents 
 * @author Fogler Tibor
 */
 
 
class AmprojectModelEvents  extends AmprojectModel { 

	
	
	protected $_default_filter = 'a.tablename';   
 ...
 */
	...
	*/
	...
	protected function _buildContentWhere() 
	{
		...
		if ($search) {
			$this->_query->where('LOWER(a.tablename) LIKE ' . $this->_db->Quote('%' . $search . '%'));			
		}

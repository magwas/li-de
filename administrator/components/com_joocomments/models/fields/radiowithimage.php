 ...
 */
class JFormFieldRadioWithImage extends JFormFieldRadio
{
/**
	 * The form field type.
	 *
	...
	protected function getInput()
	{
		...
		foreach ($options as $i => $option) {
			...
			$html[] 	= JHTML::_('image', 'administrator/components/com_joocomments/assets/'.$option->value.'.png','' );

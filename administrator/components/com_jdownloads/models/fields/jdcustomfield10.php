 ...
 * @since		1.6
 */
class JFormFieldjdCustomField10 extends JFormField
{
	/**
	 * The form field type.
	 *
	 ...
	 * @since	1.6
	 */
	protected $type = 'jdCustomField10';
    ...
    public function getLabel() {
        ...
        $text = $this->element['label'] ? (string) $this->element['label'] : (string) $jlistConfig['custom.field.10.title'];;

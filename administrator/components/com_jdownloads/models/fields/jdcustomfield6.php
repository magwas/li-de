 ...
 * @since		1.6
 */
class JFormFieldjdCustomField6 extends JFormField
{
	/**
	 * The form field type.
	 *
    ...
    public function getLabel() {
        ...
        $text = $this->element['label'] ? (string) $this->element['label'] : (string) $jlistConfig['custom.field.6.title'];;
	...
	protected function getInput()
	{
        ...
        if ($this->value != ''){
            ...
            $field->setup($this->element, htmlspecialchars(trim($jlistConfig['custom.field.6.values']), ENT_COMPAT, 'UTF-8'));
        }

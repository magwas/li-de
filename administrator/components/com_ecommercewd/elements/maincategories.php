...
class JFormFieldMaincategories extends JFormField
{
	...
	public function getInput()
	{
		...
		$categories = $this->getCategories($this->value);
		
		$module_name = $this->element['moduleName'];		
		
		?>
			<div class="wdshop_mod_panel">
				<?php echo WDFHTML::jf_module_box('category_box'); ?>
				<span id="buttons_container">
					<?php echo WDFHTML::jfbutton(WDFText::get_mod('BTN_ADD_CATEGORIES',$module_name), '', '', 'onclick="onBtnAddCategoriesClick(event, this);"', WDFHTML::BUTTON_COLOR_BLUE, WDFHTML::BUTTON_SIZE_SMALL, WDFUrl::get_com_admin_url() . '/images/btn_add_logo.png'); ?>
					<?php echo WDFHTML::jfbutton(WDFText::get_mod('BTN_REMOVE_ALL',$module_name), '', '', 'onclick="onBtnRemoveAllCategoriesClick(event, this);"', WDFHTML::BUTTON_COLOR_RED, WDFHTML::BUTTON_SIZE_SMALL, WDFUrl::get_com_admin_url() . '/images/btn_remove_logo.png'); ?>
				</span>
				<script> 
		...
		<?php
		WDFHelper::add_script('js/modules/main_modules.js');	

    ...
    private function create_toolbar() {
        switch (WDFInput::get_task()) {
            case 'explore':
                break;
            case 'add':
                JToolBarHelper::title(WDFText::get('ADD_DISCOUNT'), 'spidershop_discounts.png');
                ...
                break;
            case 'edit':
                JToolBarHelper::title(WDFText::get('EDIT_DISCOUNT'), 'spidershop_discounts.png');
                ...
                break;
            default:
                JToolBarHelper::title(WDFText::get('DISCOUNTS'), 'spidershop_discounts.png');

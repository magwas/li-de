...
class EcommercewdViewCountries extends EcommercewdView {
    ////////////////////////////////////////////////////////////////////////////////////////
    // Events                                                                             //
    ////////////////////////////////////////////////////////////////////////////////////////
    ////////////////////////////////////////////////////////////////////////////////////////
    ...
    private function create_toolbar() {
        switch (WDFInput::get_task()) {
            case 'add':
                JToolBarHelper::title(WDFText::get('ADD_COUNTRY'), 'spidershop_countries.png');
                ...
                break;
            case 'edit':
                JToolBarHelper::title(WDFText::get('EDIT_COUNTRY'), 'spidershop_countries.png');
                ...
                break;
            default:
                JToolBarHelper::title(WDFText::get('COUNTRIES'), 'spidershop_countries.png');

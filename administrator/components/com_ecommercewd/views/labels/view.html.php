...
class EcommercewdViewLabels extends EcommercewdView {
    ////////////////////////////////////////////////////////////////////////////////////////
    // Events                                                                             //
    ////////////////////////////////////////////////////////////////////////////////////////
    ////////////////////////////////////////////////////////////////////////////////////////
    ...
    private function create_toolbar() {
        switch (WDFInput::get_task()) {
            case 'add':
                JToolBarHelper::title(WDFText::get('ADD_LABEL'), 'spidershop_labels.png');
                ...
                break;
            case 'edit':
                JToolBarHelper::title(WDFText::get('EDIT_LABEL'), 'spidershop_labels.png');
                ...
                break;
            default:
                JToolBarHelper::title(WDFText::get('LABELS'), 'spidershop_labels.png');

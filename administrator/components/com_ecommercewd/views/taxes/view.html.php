...
class EcommercewdViewTaxes extends EcommercewdView {
    ...
    private function create_toolbar() {
        switch (WDFInput::get_task()) {
            case 'add':
                JToolBarHelper::title(WDFText::get('ADD_TAX'), 'spidershop_taxes.png');
                ...
                break;
            case 'edit':
                JToolBarHelper::title(WDFText::get('EDIT_TAX'), 'spidershop_taxes.png');
                ...
                break;
            default:
                JToolBarHelper::title(WDFText::get('TAXES'), 'spidershop_taxes.png');

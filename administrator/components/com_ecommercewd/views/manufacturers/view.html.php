...
class EcommercewdViewManufacturers extends EcommercewdView {
    ...
    private function create_toolbar() {
        switch (WDFInput::get_task()) {
            case 'add':
                JToolBarHelper::title(WDFText::get('ADD_MANUFACTURER'), 'spidershop_manufacturers.png');
                ...
                break;
            case 'edit':
                JToolBarHelper::title(WDFText::get('EDIT_MANUFACTURER'), 'spidershop_manufacturers.png');
                ...
                break;
            default:
                JToolBarHelper::title(WDFText::get('MANUFACTURERS'), 'spidershop_manufacturers.png');

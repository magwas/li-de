...
<form name="adminForm" id="adminForm" action="" method="post">
    ...
    <table class="adminlist table table-striped">
        ...
        <tr>
            ...
            <th class="col_logo">
                <?php echo WDFText::get('LOGO'); ?>
            </th>

            <th class="col_site">
                <?php echo WDFText::get('WEBSITE'); ?>
            </th>
        ...
        for ($i = 0; $i < count($rows); $i++) {
            ...
            <tr class="row<?php echo $i % 2; ?>">
                ...
                <td class="col_logo">
                    ...
                    if ($row->logo != '') {
                        ?>
                        <img src="<?php echo JURI::root().$row->logo; ?>" class="manufacturer_logo" alt="<?php echo $row->name; ?>">
                    <?php
                    }
                    ?>
                </td>
                ...
                <td class="col_site">
                    <?php
                    if ($row->site != '') {
                        echo WDFHTML::jfbutton_inline($row->site, WDFHTML::BUTTON_INLINE_TYPE_GOTO, '', '', 'href="' . $row->site . '" target="_blank"', WDFHTML::BUTTON_ICON_POS_RIGHT);
                    }
                    ?>
                </td>

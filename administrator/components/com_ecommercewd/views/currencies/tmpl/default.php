...
<form name="adminForm" id="adminForm" action="" method="post">
    ...
    <table class="adminlist table table-striped">
        ...
        <tr>
            ...
            <th class="col_code">
                <?php echo JHTML::_('grid.sort', WDFText::get('CURRENCY_CODE'), 'code', $sort_order, $sort_by); ?>
            </th>

            <th class="col_default">
                <?php echo JHTML::_('grid.sort', WDFText::get('DEFAULT'), 'default', $sort_order, $sort_by); ?>
            </th>
        </tr>
        </thead>
        ...
        for ($i = 0; $i < count($rows); $i++) {
            ...
            <tr class="row<?php echo $i % 2; ?>">
                ...
                <td class="col_default">
                    ...
                    if ($row->default == 1) {
                        ?>
                        <img src="templates/hathor/images/header/icon-48-default.png">
                    <?php
                    }
                    ?>
                </td>

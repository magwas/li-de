...
<tr>
    <td class="col_key">
        <label><?php echo WDFText::get('ENABLE_SHIPPING') ?>:</label>
    </td>
	<td class="col_value">
		<?php echo JHTML::_('select.radiolist',$list_shipping_data_field, 'enable_shipping', 'onchange="onShippingChange(this);"', 'value', 'text', $row->enable_shipping); ?>
	</td>
</tr>
...
<tr id="shipping_methods" class="shipping_info">
    ...
    <td class="col_value">
        ...
        <input type="hidden"
               ...
               value="<?php echo implode(',', $row->shipping_method_ids); ?>"/>
    </td>
</tr>
<!-- product weight -->
<tr class="shipping_info">
    <td class="col_key">
        <label for="weight"><?php echo WDFText::get('WEIGHT'); ?>:</label>
    </td>
	<td class="col_value">
		<input type="text"
		   name="weight"
...
<tr class="shipping_info">
    <td class="col_key">
        <label for="dimensions_length"><?php echo WDFText::get('DIMENSIONS_L_W_H') ?>:</label>
    </td>
	<td class="col_value">
		<input type="text"

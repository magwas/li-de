    ...
    <table class="adminlist table table-striped">
        ...
        <tr>
            ...
            <th class="col_description">
                <?php echo JHtml::_('grid.sort', WDFText::get('DESCRIPTION'), 'description', $sort_order, $sort_by); ?>
            </th>

            <th class="col_products">
        ...
        for ($i = 0; $i < count($rows); $i++) {
            ...
            <tr class="row<?php echo $i % 2; ?>">
                ...
                <td class="col_products">
                    <?php echo WDFHTML::jfbutton_inline($row->products_count, WDFHTML::BUTTON_INLINE_TYPE_GOTO, '', '', 'href="' . $row->show_products_url . '"', WDFHTML::BUTTON_ICON_POS_RIGHT); ?>
                </td>
				<td class="col_image">

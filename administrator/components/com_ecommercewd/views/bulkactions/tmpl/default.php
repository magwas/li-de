...
WDFHelper::add_css('bootstrap/css/bootstrap.css');
// js
...
<form name="adminForm" id="adminForm" action="" method="POST">
            ...
            <tr class="row<?php echo $i % 2; ?>">
                ...
                <td class="col_checked">
					 ...
					 <input type="checkbox"
                       ...
                       onclick="wd_ShopCheck_this(this);"/>
                </td>
    ...
    <input type="hidden" name="boxcheckeds" value=""/>
    <input type="hidden" name="gag" value="gag"/>
    <input type="hidden" name="sort_by" value="<?php echo $sort_by; ?>"/>
    <input type="hidden" name="sort_order" value="<?php echo $sort_order; ?>"/>
</form>

<script> var msg_edit = "<?php echo WDFText::get("MSG_SELECTION_FROM_THE_LIST");?>"</script>

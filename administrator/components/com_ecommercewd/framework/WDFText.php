...
class WDFText {
     ...
     * @args    mixed arguments for sprintf.
     *
    ...
    public static function get($text) {
        ...
        $args = func_get_args();	
		$args[0] = 'COM_' . strtoupper($com_name) . '_' . $args[0];
        $result = call_user_func_array('JText::sprintf', $args);

        return $result;
    }
	
	public static function get_mod($text, $extens_name = "" ) {
        $com_name = WDFHelper::get_com_name();
		
        $args = func_get_args();

		$args[0] = 'MOD_' . strtoupper($extens_name) . '_' . $args[0];
        $result = call_user_func_array('JText::sprintf', $args);

...
class JFormFieldListManufacturer extends JFormField {
    ////////////////////////////////////////////////////////////////////////////////////////
    // Events                                                                             //
    ////////////////////////////////////////////////////////////////////////////////////////
    ////////////////////////////////////////////////////////////////////////////////////////
    ...
    // Variables                                                                          //
    ////////////////////////////////////////////////////////////////////////////////////////
    protected $type = 'ListManufacturer';
    ...
    public function getInput() {
        ...
        $list_manufacturers = WDFDb::get_list('manufacturers', 'id', 'name', 'published = 1','',array());
        echo JHtml::_('select.genericlist', $list_manufacturers, $this->name, '', 'id', 'name', $this->value, $this->id);
